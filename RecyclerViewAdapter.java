...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(ArrayList<String> fotorumahsakit, ArrayList<String> namarumahsakit,ArrayList<String> namakota, ArrayList<String> info, ArrayList<String> fasilitas,  ArrayList<String> notelpon, Context context) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(context, namamahasiswa.get(position), Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra("notelpon", notelpon.get(position));
